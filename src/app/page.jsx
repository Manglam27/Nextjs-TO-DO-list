...
const Todo = async() => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-end items-center text-4xl md:text-5xl mt-5 md:mt-8">
            <button className="border border-slate-300 text-slate-300 px-2 py-1 rounded hover:bg-slate-700 focus-within:bg-slate-700 outline-none" >Remove Old</button>
            </div>
            <div className=" mt-[0px] pl-5" >
                <ul>
                    {Todo_data.map((Todo) => (
